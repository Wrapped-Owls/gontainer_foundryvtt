...
func (*stubFoundryClient) Switch(context.Context, string, command.Interrupt) error { return nil }
func (*stubFoundryClient) Restart(context.Context, command.Interrupt) error        { return nil }
